...
class _AutoLockProfilesScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Auto-Lock Profiles')),
          ...
          : profiles.isEmpty
              ? const Center(
                  child: Padding(
                    ...
                    child: Text(
                      'No auto-lock profiles yet. Create one to lock the '
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return ListTile(
                      ...
                      title: Text(p.name),
                      subtitle: Text(
                        '${_formatTimeout(p.timeoutSeconds)}'
                        '${p.lockOnMinimize ? ' • lock on minimize' : ''}'
                        '${p.isActive ? ' • active' : ''}',
                      ),
                      leading: Icon(
                        p.isActive
...
class _AutoLockProfileFormDialogState
  ...
  void _save() {
    ...
    if (timeout == null || timeout <= 0) {
      setState(() => _error = 'Timeout must be a positive integer.');
      return;
    }
    Navigator.pop(
      context,
      ...
      content: Column(
        ...
        children: [
          ...
          SwitchListTile(
            ...
            title: const Text('Lock on minimize'),
